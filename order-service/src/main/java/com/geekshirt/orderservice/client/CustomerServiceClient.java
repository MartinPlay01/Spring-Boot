...
public class CustomerServiceClient {
    ...
    public AccountDto  createDummyAcount(){
        ...
        CustomerDto customer = CustomerDto.builder().lastName("Madero")
                                                    .firstName("Juan")
                                                    .email("juan.made@xyz.com").build();

        CreditCardDto creditCard = CreditCardDto.builder().nameOnCard("Juan Madero")
                                                    .number("432012314552274")
                                                    .expirationMonth("03")
                                                    .expirationYear("2023")
                                                    .ccv("123")
                                                    .type("VISA").build();
